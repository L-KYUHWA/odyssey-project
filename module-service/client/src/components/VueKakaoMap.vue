...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      addMarker() {
        const iwPosition = new daum.maps.LatLng(this.center.lat, this.center.lng);
        const iwContent = '<div style="padding:5px;">' + this.markerInfo.placeName + '<br>' + this.markerInfo.addressMame + '</div>'
